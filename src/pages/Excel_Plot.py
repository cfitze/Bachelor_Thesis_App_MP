...
import pathlib # to use the path of the current module
...
DATA_PATH_ASSETS = PATH.joinpath("assets").resolve()
...
import_excel = pickle.load(DATA_PATH_PICKLE.joinpath(filename_excel).open("rb"))
